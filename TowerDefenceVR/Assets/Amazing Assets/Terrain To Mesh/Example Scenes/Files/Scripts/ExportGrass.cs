...
namespace AmazingAssets.TerrainToMesh.Example
{
    ...
    public class ExportGrass : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DetailPrototypesData[] detailPrototypesData = terrainData.TerrainToMesh().ExportGrassData(vertexCountHorizontal, vertexCountVertical, 1, 1, 8);
            ...
            for (int t = 0; t < detailPrototypesData.Length; t++)
            {
                ...
                for (int p = 0; p < detailPrototypesData[t].position.Count; p++)
                {
                    ...
                    //Add random rotation
                    grass.transform.localRotation = Quaternion.Euler(0, detailPrototypesData[t].rotationY[p], 0);
